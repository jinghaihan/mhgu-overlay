...
Locale resolve_locale(
  const GameId game, const LocaleMode mode, const Locale detected_locale
) {
  switch (mode) {
...
const char*
localized_name(const MonsterDefinition& monster, const Locale locale) {
  switch (locale) {
...
const char* size_preset_label(const SizePreset preset, const Locale locale) {
