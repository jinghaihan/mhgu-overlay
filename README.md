...
- Adds invincibility and no-health-decrease options under the grouped
  battle-functions menu.
...
- **Battle functions** groups hunter, combat-parameter, and Palico modifiers.
  **Invincible** and **Health does not decrease** are one-way, non-persistent
  instruction patches.
